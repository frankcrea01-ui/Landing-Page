...
const services = [
  {
    ...
    description: 'Desarrollo de planos estructurales, memorias de cálculo y modelado para edificaciones seguras y eficientes.',
    icon: Building2,
    image: '/obra.jpeg',
    ...
    <section id="servicios" className="py-24 bg-slate-50 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div ref={headerRef} className="text-center max-w-3xl mx-auto mb-16 opacity-0">
          ...
          <h3 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">Soluciones en Ingeniería Civil</h3>
          <p className="text-lg text-slate-600">
            Servicios orientados a resolver problemas reales en diseño, ejecución de obra y formalización de propiedades.
          </p>
        </div>
